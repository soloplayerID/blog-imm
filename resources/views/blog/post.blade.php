      ...
      <div class="col-sm-8">
				...
				<div class="container my-5">
				  <div style="max-width: 700px; top: -80px;" class="mx-auto text-secondary">
				    ...
				    <h1 class="font-weight-bold text-dark">{{$post->judul}}
				</h1>
				    <p class="my-2" style="line-height: 2;">{!! substr($post->content,0,120) !!}</p>
				    ...
				    <div class="my-3 d-flex align-items-center justify-content-between">
				      ...
				      <small class="ml-2">
				        <a href="#" class="text-primary d-block"> {{ $post->user->name}}</a>
				  ...
				  <img class="w-100 my-3" src="{{asset($post->image)}}" />
